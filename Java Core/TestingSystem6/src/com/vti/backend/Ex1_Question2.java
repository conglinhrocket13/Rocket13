...
//		QLCB qlcb = new QLCB(); //tạm để thành comment cho đỡ hiện lỗi. em copy code sang chứ không import project
		
// Sửa lỗi: Vòng lặp While nên đặt ở đây
		while (true) {
...
// Lỗi: bắt nhập thêm cán bộ do đặt vòng lặp While
//		while (true) {
			switch (choose) {
			case 1:
//				qlcb.addCanBo();
