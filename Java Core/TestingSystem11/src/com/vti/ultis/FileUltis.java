...
public class FileUltis {
	public static final String FILE_EXISTS = "File is exist!";
	public static final String FILE_NOT_EXISTS = "Error! File Not Exist.";
	public static final String FOLDER_EXISTS = "Folder is exist!";
	public static final String FOLDER_NOT_EXISTS = "Folder is not exist!";
	public static final String PATH_NOT_FOLDER = "Error! Path is not folder.";

	public static final String SOURCE_FILE_NOT_EXISTS = "Source File is not exist!";
	public static final String DESTINATION_FILE_EXISTS = "Destination File is exist!";
	...
	// Create New Folder
		public static void createNewFolder(String path, String fileName) throws Exception {
			String pathFile = path + "//" + fileName;
			createNewFolder(pathFile);
		}
}
